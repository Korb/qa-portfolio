...
**Basic settings:**
- Scan profile: "Сканирование изображения" (Image Scan)
...
You can also use ABBYY FineReader OCR-редактор (File / Сканировать страницы) or the "Acquire images from scanner" tool in FastStone Image Viewer. FineReader won't save images separately unless you save the OCR project.

For flatbed scanning with Epson Scan: Enhanced with Epson Easy Photo Fix 3.9.2.1RU, the settings that work are:

**Режим (Mode):** Профессиональный режим  
**Оригинал:**
...
6. When you're done reordering, select all images and press F2
...
- Select the files
- Press F3 (opens the Batch Convert tab)
...
After digitization is complete, follow the OCR workflow (separate document) to add the searchable text layer.

---

**Time estimates:**
- Preparation: 5-15 minutes per document depending on format
- Scanning: 1-2 minutes per page (auto-feed) or 3-5 minutes per page (flatbed)
- Post-processing: 5-10 minutes per document
